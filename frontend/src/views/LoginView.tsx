...
export const LoginView = () => {
  ...
  return (
    <div className="bg-header bg-cover min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
